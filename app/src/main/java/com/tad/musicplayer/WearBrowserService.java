...
import com.tad.musicplayer.dataloaders.AlbumLoader;
import com.tad.musicplayer.dataloaders.AlbumSongLoader;
import com.tad.musicplayer.dataloaders.ArtistAlbumLoader;
import com.tad.musicplayer.dataloaders.ArtistLoader;
import com.tad.musicplayer.dataloaders.ArtistSongLoader;
import com.tad.musicplayer.dataloaders.PlaylistLoader;
import com.tad.musicplayer.dataloaders.PlaylistSongLoader;
import com.tad.musicplayer.dataloaders.SongLoader;
import com.tad.musicplayer.models.Album;
import com.tad.musicplayer.models.Artist;
import com.tad.musicplayer.models.Playlist;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "tad.musicplayer/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "tad.musicplayer/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "tad.musicplayer/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "tad.musicplayer/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
